...
import map from 'src/client/assets/map.png';
import flag1 from 'src/client/assets/uk-flag.svg';
import flag2 from 'src/client/assets/south-africa-flag.svg';
import flag3 from 'src/client/assets/spain-flag.svg';
